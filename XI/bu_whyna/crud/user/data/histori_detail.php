...
<div style="margin:15px;">
    ...
    <?php if (file_exists("../../assets/bukti/$id")):?>
    <h3>Bukti pengantaran</h3>
    <img src="../../assets/bukti/<?= $id ?>">
    <?php endif ?>
    ...
    */
    ...
    WHERE id_history = ?', ['s', $id]);
        ...
        <table class="table table-hover table-striped">
            ...
            WHERE id_history = ? ORDER BY id_urutan LIMIT ?, ?', ['sss', $id, $start, $akhir]);
                ...
                ?>
                    <tr>
                        ...
                        <td><a class="btn btn-success" href="produk_detail.php?id_produk=<?= $dt_history['id_produk'] ?>">Detail produk</a></td>
                    </tr>
                <?php
                } ?>
            </tbody>
